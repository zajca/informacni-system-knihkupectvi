...
module.exports = ["$stateProvider", "$urlRouterProvider","$locationProvider","$logProvider","$provide","$httpProvider",($stateProvider, $urlRouterProvider,$locationProvider,$logProvider,$provide,$httpProvider) ->
