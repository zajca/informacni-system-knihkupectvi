/**
  *Zdrojový kód převzat
  *https://github.com/JakubMrozek/Zdrojak 
  */
...
/**
 * Chyba nastava pri neuspesnem loginu.
 */

function InvalidLoginData(message) {
  message = message || 'Zadané přihlašovací údaje jsou chybné.';
  HttpResponseError.call(this, message, 400);
}
util.inherits(InvalidLoginData, HttpResponseError);
